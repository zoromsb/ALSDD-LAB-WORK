...
int main(void) {
    ...
    size_t *para_count = NULL;
    int done = 0;
menu:   
printf(" ====== ALSDD LAB WORK: Set Operations on Texts ====== \n");
printf("||                                                   ||\n");
printf("||  [1] load files                                   ||\n");
printf("||  [2] extract paragraphs and sentences             ||\n");
printf("||  [3] perform set operations                       ||\n");
...
if (!done) {
    ...
    para_count = calloc(text.size, sizeof(size_t));
    size_t tot_para = 0;
...
if (!done) {
    ...
    /* free all loaded data and go back to menu */  
cleanup:
